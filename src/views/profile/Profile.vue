<template>
  <div id="profile">
    <nav-bar class="nav-bar"><div slot="center">个人信息</div></nav-bar>
    <user-info />
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        // orderList: [
        //   {src: '~assets/img/profile/message.svg', info: '我的消息'},
        //   {src: '~assets/img/profile/pointer.svg', info: '积分商城'},
        //   {src: '~assets/img/profile/vip.svg', info: '会员卡'},
        // ],
        // serviceList: [
        //   {src: '~assets/img/profile/cart.svg', info: '我的购物车'},
        //   {src: '~assets/img/profile/shopping.svg', info: '下载购物APP'},
        // ]
        orderList: [
